              ...
              <section className="relative overflow-hidden rounded-[28px] border border-line/80 bg-white shadow-[0_15px_50px_rgba(0,0,0,0.05)] dark:border-[#293832] dark:bg-[#1a2521] lg:col-span-2">
                ...
                <div className="relative p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-7 space-y-5 text-base leading-8 text-muted dark:text-gray-300 sm:text-[17px] sm:leading-9">
                    ...
                    <p>
                      &#39;बेस्ट खबर डटकम&#39; पत्रकारिता क्षेत्रमा फरक र उत्कृष्ट
                      खबर पस्कने लक्ष्यका साथ स्थापित &#39;अनलाईन न्युज पोर्टल&#39;
                      हो। हामी हाम्रा आदरणीय पाठकवर्गलाई फरक खालको र विश्वसनीय समाचार
                      दिने न्यूज पोर्टलको रुपमा बेस्ट खबरलाई अगाडि बढाउने प्रयासमा
                      छौं।
                    </p>

                    <p>
                      पत्रकारिताको मर्म र मान्यतालाई आत्मसाथ गर्दै अघि बढ्ने हाम्रो
                      प्रण हुनेछ। समाचार दिने नाममा हतारो गर्ने र समाचारका नाममा
                      समाजलाई आतङ्कित बनाउने, वितृष्णा फैलाउने समाचार र श्रव्यदृष्य
                      हामी कहिल्यै पनि प्रकाशन तथा प्रशारण गर्ने छैनौं। हामी हाम्रा
                      पाठकवर्ग, समस्त विज्ञापनदाता र शुभचिन्तक माझ विश्वसनीय र
                      प्रभावकारी न्यूज साईटको रुपमा स्थापित हुने जमर्कोमा छौं।
                    </p>

                    <p>
                      पार्टीकारिता होइन पत्रकारिता हाम्रो मूल मर्म हुनेछ। आम नागरिकमा
                      सकारात्मक सन्देश तथा सकारात्मक समाचार प्रवाह गर्नु हाम्रो मूल
                      ध्येय हुनेछ। समाज परिवर्तनमा महत्वपूर्ण घटना, व्यक्ति तथा
                      समूहका बारेमा हामी विशेष प्राथमिकताका साथ समाचार तथा जानकारीहरू
                      संप्रेषित गर्दछौं।
                    </p>
                    ...
                    <p>
                      ...
                      त्यसैले माथिका हाम्रा मर्म र सिद्धान्त भित्रै रहेर स–प्रमाण
                      समाचार, जानकारी तथा सूचनाहरू पठाइदिनु हुन विनम्र अनुरोध
                      गर्दछौं।
                    </p>
                ...
                <section className="relative overflow-hidden rounded-[28px] border border-line/80 bg-white shadow-[0_15px_50px_rgba(0,0,0,0.05)] dark:border-[#293832] dark:bg-[#1a2521]">
                  ...
                  <div className="p-6">
                    ...
                    <p className="mt-4 border-b border-line pb-5 text-sm leading-6 text-muted dark:border-[#293832] dark:text-gray-400">
                      &#39;पिवेभ्स भिजन कर्नर प्रा.लि.&#39; (Pwaves Vision Corner Pvt.
                      Ltd.) द्वारा सञ्चालित
                    </p>
